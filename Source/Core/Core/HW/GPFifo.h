...
#ifdef __SWITCH__
constexpr u32 GATHER_PIPE_JIT_FLUSH_SIZE = GATHER_PIPE_SIZE * 4;
#else
constexpr u32 GATHER_PIPE_JIT_FLUSH_SIZE = GATHER_PIPE_SIZE;
#endif
static_assert(GATHER_PIPE_JIT_FLUSH_SIZE + GATHER_PIPE_SIZE * 2 <= GATHER_PIPE_EXTRA_SIZE);
